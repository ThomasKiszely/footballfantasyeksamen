...
describe('userController', () => {
    ...
    it('Should return status 200 and json', async () => {
        ...
        vi.spyOn(userService, 'getUser').mockResolvedValue(mockResponse);
    ...
    it('Should return 201 and created user', async () => {
        const mockResponse = { name: 'John', password: '1234', point: 0, budget: 0 };
        vi.spyOn(userService, 'createUser').mockResolvedValue(mockResponse);

        const req = {body: { name: 'John', password: '1234', point: 0, budget: 0 } };
